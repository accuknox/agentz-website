...
const ITEMS: ExpandableItem[] = [
  { title: 'Chat with agents', description: 'Ask, build, and run workflows in plain language. Files, artifacts, and full run history stay with the agent.', src: './assets/video/0-agentz-chat.mp4', poster: './assets/video/0-agentz-chat.jpg', label: 'Chat interface in AgentZ' },
  ...
  { title: 'Runtime in full view', description: 'Every egress by domain, port and protocol, allowed or blocked at the kernel and recorded. Nothing leaves without a record.', src: './assets/video/runtime-traces-telemetry.mp4', poster: './assets/video/runtime-traces-telemetry.jpg', label: 'Runtime telemetry in AgentZ' },
  ...
  { title: 'Generate skills on demand', description: 'Describe the task. AgentZ writes the skill, wires the steps, and makes it reusable across the team.', src: './assets/video/dynamic-skill-generation.mp4', poster: './assets/video/dynamic-skill-generation.jpg', label: 'Dynamic skill generation in AgentZ' },
]
    ...
    <section className="feature alt" id="demos">
      <div className="wrap">
        <div className="fhead center">
          ...
          <p className="fhead-p">Workflows drawn from security operations. Select a card to expand it.</p>
        </div>
