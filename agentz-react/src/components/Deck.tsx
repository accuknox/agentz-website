...
const SLIDES: Slide[] = [
  {
    ...
    alt: 'AgentZ title slide: build, run and govern production agents, secure by design',
  },
  {
  ...
  },
  {
    ...
    alt: 'Sandbox update screen with per-tool toggles for each connected MCP server',
  },
  {
  ...
  },
  {
    ...
    alt: 'A cloud asset count diff report generated by an agent, next to its output files',
  },
  {
  ...
  },
  {
    ...
    alt: 'Workflow run graph with a step inspector showing status, timings and instructions',
  },
  {
  ...
  },
  {
    ...
    alt: 'AccuKnox and AgentZ closing slide with SOC 2, CNCF, AWS and Nutanix certifications',
  },
]
